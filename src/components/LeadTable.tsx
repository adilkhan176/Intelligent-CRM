        ...
        <table className="w-full text-sm sm:min-w-[560px]">
          <thead>
            <tr className="border-b border-hairline text-left text-xs text-ink-muted uppercase tracking-wide">
              ...
              <th className="px-4 py-2.5 font-medium hidden sm:table-cell">Project</th>
          ...
          <tbody>
            {leads.map((lead) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-ink-secondary hidden sm:table-cell">{lead.projectType}</td>
                <td className="px-4 py-3 text-ink-secondary hidden md:table-cell">{lead.source}</td>
